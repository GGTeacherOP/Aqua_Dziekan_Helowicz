document.addEventListener('DOMContentLoaded', function () {
    ...
    if (spaPageIdentifier) {
        ...
        const spaTreatmentCategories = [
            ...
            { id: 'zabiegi_cialo', name: 'Luksusowe Zabiegi na Ciało', treatments: [ { id: 'peeling_cukrowy', name: 'Aromatyczny Peeling Cukrowy Całego Ciała - 190 PLN', price: 190 }, { id: 'oklad_czekoladowy', name: 'Odżywczy Okład Czekoladowy - 330 PLN', price: 330 }, { id: 'rytual_zielona_herbata', name: 'Detoksykujący Rytuał z Zieloną Herbatą - 380 PLN', price: 380 } ] },
